...
export const premiumProcedure = (entity: 'meetings' | 'agents') =>
        protectedProcedure.use(async ({ ctx, next }) => {
                ...
                if (shouldThrowAgentError) {
                        throw new TRPCError({
                                code: 'FORBIDDEN',
                                message: `You have reached the limit for free agents. Please upgrade to continue using this feature.`,
                        });
                }
                ...
                if (shouldThrowMeetingError) {
                        throw new TRPCError({
                                code: 'FORBIDDEN',
                                message: `You have reached the limit for free meetings. Please upgrade to continue using this feature.`,
                        });
                }
