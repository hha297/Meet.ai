...
const pricingCardBadegeVariants = cva('text-black text-xs font-normal p-1', {
        variants: {
                variant: {
        ...
        return (
                <div className={cn(pricingCardVariants({ variant }), className, 'border')}>
                                        ...
                                        <div className="flex items-center gap-x-2">
                                                ...
                                                <h6 className="font-medium text-xl">
                                                        {badge ? (
                                                                <Badge
                                                                        className={cn(
                                                                                pricingCardBadegeVariants({ variant }),
                                                                        )}
                                                                >
                                                                        {badge}
                                                                </Badge>
                        ...
                        <div className="flex flex-col gap-y-2 mt-6">
                                ...
                                <ul className={cn('text-xs', pricingCardSecondaryTextVariants({ variant }))}>
