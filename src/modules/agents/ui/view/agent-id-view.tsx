...
export const AgentIdView = ({ agentId }: AgentIdViewProps) => {
        ...
        const [RemoveConfirmation, confirmRemove] = useConfirm(
                'Delete Agent',
                `Are you sure you want to delete this agent? This action will remove ${data.meetingCount} associated meetings and cannot be undone.`,
        );
        ...
        return (
                <>
                        ...
                        <UpdateAgentDialog
                                ...
                                initialValues={data}
                        />
                        <div className="flex-1 py-4 px-4 md:p-8 flex flex-col gap-y-4">
                                <AgentIdViewHeader
                                        agentId={agentId}
                                        agentName={data.name}
                                ...
                                <div className="bg-white rounded-lg border">
                                        <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
                                                ...
                                                >
                                                        <VideoIcon className="text-blue0700" />
                                                        {data.meetingCount}{' '}
